...
-   Nov, 2025: Fork and Tweaks by Exceret. 
...
-   Prerequisites: Scissor is developed under R (*version \>= 3.6.1*). The [Seurat](https://satijalab.org/seurat/) package (*version \>= 3.2.0*) is used for loading data and preprocessing.
